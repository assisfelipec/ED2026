...
for(int i = 0; i < newNumbersBi.GetLength(0); i++)
{
    ...
    {
        System.Console.Write($"[{newNumbersBi[i, j]}] ");
    }
    System.Console.WriteLine("");
}

// Jagged Arrays ou Arrêi de Jegues
// Vetor de Vetores
...
// Para accesar uma posição específica
int n = jaggedNumbers[1][2];
jaggedNumbers[1][2] = 22;
System.Console.WriteLine($"\nn = {n}");
System.Console.WriteLine($"jaggedNumbers[1][2] = {jaggedNumbers[1][2]}");